...
install_golang() {
    ...
    wget https://golang.org/dl/go1.24.6.linux-${GO_ARCH}.tar.gz -O /tmp/golang1.24.6.tar.gz
    tar --transform=s,go,go1.24.6, -zxf /tmp/golang1.24.6.tar.gz
    rm -rf /usr/local/go*
    mv go1.24.6 /usr/local/
    ln -s /usr/local/go1.24.6 /usr/local/go
}

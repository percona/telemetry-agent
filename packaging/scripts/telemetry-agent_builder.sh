...
install_golang() {
    ...
    wget https://golang.org/dl/go1.25.5.linux-${GO_ARCH}.tar.gz -O /tmp/golang1.25.5.tar.gz
    tar --transform=s,go,go1.25.5, -zxf /tmp/golang1.25.5.tar.gz
    rm -rf /usr/local/go*
    mv go1.25.5 /usr/local/
    ln -s /usr/local/go1.25.5 /usr/local/go
}

...
install_golang() {
    ...
    wget https://golang.org/dl/go1.26.3.linux-${GO_ARCH}.tar.gz -O /tmp/golang1.26.3.tar.gz
    tar --transform=s,go,go1.26.3, -zxf /tmp/golang1.26.3.tar.gz
    rm -rf /usr/local/go*
    mv go1.26.3 /usr/local/
    ln -s /usr/local/go1.26.3 /usr/local/go
}
